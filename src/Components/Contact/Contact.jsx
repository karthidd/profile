        ...
        >
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item">
                 ...
                 <img src={mail_icon} alt="Email" /><h2>Mail :</h2>
                    <span>karthikeyanthavamani86@gmail.com</span>
                </motion.div>
                <motion.div className="item">
                 <img src={location_icon} alt="Email" />
                    <h2>Address :</h2>
                    <span>Kattumavadi,Pudukkotai.</span>
                </motion.div>
                <motion.div className="item">
                 <img src={call_icon} alt="Email" />
                    <h2>Phone :</h2>
                    <span>+918838166045</span>
                </motion.div>
            </motion.div>
